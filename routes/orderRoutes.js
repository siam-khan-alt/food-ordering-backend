...
const { createOrder, getMyOrders, getAllOrders, updateOrderStatus, getSingleOrder, getCustomerOrders } = require('../controllers/orderController');
...
router.get('/customer/:customerId', verifyToken, isAdmin, getCustomerOrders);
